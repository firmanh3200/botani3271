...
st.title(':orange[STATISTIK] :blue[DAERAH] :green[KOTA BOGOR]')
...
with st.expander('PENGANTAR'):
    ...
    st.info('Aplikasi ini dibuat untuk memudahkan Para Pemangku Kepentingan dalam proses Perencanaan, Pelaksanaan, \
        Monitoring dan Evaluasi Pembangunan di Kota Bogor.')
...
#     with st.container(border=True):
#         st.subheader('Luas Kota Bogor menurut Kecamatan (Km2)')

#         # URL luas wilayah
#         url = "https://data.jabarprov.go.id/api-backend//bigdata/dpmdes/idm_luas_wilayah_desa__des_kel?limit=1000&skip=0&where=%7B%22bps_nama_kabupaten_kota%22%3A%5B%22KOTA+BOGOR%22%5D%2C%22tahun%22%3A%5B%222020%22%5D%7D"
