...
st.title('Indikator Pembangunan Manusia :blue[Kota Bogor]')
...
with st.container(border=True):
    st.success('Tren IPM Kota Bogor')
...
with kol1a:
    with st.container(border=True):
        st.info('Tren Pengeluaran Perkapita Disesuaikan (000 Rp) Kota Bogor')
...
with kol1b:
    with st.container(border=True):
        st.warning('Pertumbuhan IPM Kota Bogor (%)')
...
with kol2a:
    with st.container(border=True):
        st.warning('Tren Lama Sekolah di Kota Bogor')
...
with kol2b:
    with st.container(border=True):
        st.info('Tren Usia Harapan Hidup (UHH) di Kota Bogor')
...
with st.expander('Lihat Tabel Lengkap'):
    st.success('Indikator Pembangunan Manusia Kota Bogor')
