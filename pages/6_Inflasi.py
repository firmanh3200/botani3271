...
st.title('Inflasi :blue[Kota Bogor]')
...
with st.container(border=True):
    st.success('Perkembangan Indeks Harga Konsumen (IHK) Kota Bogor')
...
with st.container(border=True):
    st.info('Inflasi Month to Month (MtM) Kota Bogor')
...
with st.container(border=True):
    st.warning('Inflasi Year to Date (YtD) Kota Bogor')
...
with st.container(border=True):
    st.success('Inflasi Year on Year (YoY) Kota Bogor')
...
with st.expander('Lihat Tabel Lengkap'):
    st.success('IHK dan Inflasi Kota Bogor')
